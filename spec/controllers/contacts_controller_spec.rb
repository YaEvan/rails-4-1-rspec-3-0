    ...
    describe 'PATCH #update' do
      ...
      context "with invalid attributes" do
        it "does not update the contact" do
          patch :update, id: @contact, contact: attributes_for(:contact, firstname: 'Lary', lastname: nil)
          @contact.reload
          expect(@contact.firstname).to_not eq("Lary")
          expect(@contact.lastname).to eq("Lili")
        end
